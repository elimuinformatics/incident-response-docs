...
description: This is a standard template we use for post-mortems at Elimu Informatics. Each section describes the type of information you will want to put in that section.
---
This is a standard template we use for post-mortems at Elimu Informatics. Each section describes the type of information you will want to put in that section.
