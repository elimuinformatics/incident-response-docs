...
1. Notify internal stakeholders as necessary, adding subscribers to the OpsGenie incident. We have pre-defined teams called "P1 Stakeholders" and "P2 Stakeholders" which can be used.
