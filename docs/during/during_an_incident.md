...
1. Notify internal stakeholders as necessary, adding subscribers to the OpsGenie incident. We have predefined teams called "P1 Stakeholders" and "P2 Stakeholders" which can be used.
