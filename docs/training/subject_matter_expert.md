...
1. Make sure you have set up your alerting methods, and that OpsGenie can [bypass your "Do Not Disturb" settings](https://support.pagerduty.com/docs/notification-phone-numbers).
