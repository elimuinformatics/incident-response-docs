...
description: Learning about the Elimu Informatics major incident response process is an important part of being an effective on-call engineer at Elimu Informatics. This section goes over our training material for the various roles that are involved in our incident response, along with some additional information and training material from government agencies.
---
Learning about the Elimu Informatics major incident response process is an important part of being an effective on-call engineer at Elimu Informatics. This section goes over our training material for the various roles that are involved in our incident response, along with some additional information and training material from government agencies.
...
* [SME / Resolver Training](../training/subject_matter_expert.md) - This is relevant to everyone at Elimu Informatics who are on-call for any team.
...
## Training Courses
We've also published slides and videos of some of our training courses. Originally used internally at Elimu Informatics to train our staff, we've since adapted them for a wider audience so you can make use of them in your own organizations.
...
Here are a few of the systems we looked at in more detail in order to adapt and improve our own process at Elimu Informatics.
