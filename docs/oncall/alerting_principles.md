...
| -------- | ------ | -------- |
| High | High-Priority Alert 24/7/365. | Requires **immediate human action**. |
| Medium | High-Priority Alert during **business hours only**. | Requires human action within 24 hours. |
| Low | Low-Priority Alert 24/7/365. | Requires human action at some point. |
| Notification | Suppressed Event. | No response required. Informational only. |
...
Make sure to test all new and modified alerts. This is usually covered as part of [Failure Friday](https://www.youtube.com/watch?v=XKl-7hB3paY){:target="_blank" } for any new service; however, you should manually test them if you need it more quickly. Some things to test:
